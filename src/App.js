          ...
          <Fragment>
            ...
            <Alerts />
              <Switch>
                ...
                <PrivateRoute path="/payment" component={Payment} next={"payment"}/>
                <Route path="/tours" component={Tours} />
                <PrivateRoute path="/thanks" component={Thanks}  next={"thanks"}/>
                <Route path="/attractions" component={Attractions} />
                <Route path="/travel/info" component={DisplayResult} />
                <PrivateRoute path="/users/dashboard" component={Dashboard} next={"users/dashboard"}/>
              </Switch>
              <Footer />
            </div> 
          </Fragment>
