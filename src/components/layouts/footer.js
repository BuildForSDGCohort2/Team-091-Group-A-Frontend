        ...
        <div className="row">
          <div className="col-12 col-sm-7 mb-3 order-2 order-md-1">
            ...
            <p className="footer-text">
              ...
              Voluptatum qui nam ipsum dolor temporibus reiciendis, sequi
              reprehenderit facere alias illo velit, eveniet ratione rem? Facere
              ipsum molestiae nobis recusandae! Tenetur?
            </p>
            <p className="footer-text">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni
              nostrum enim ut minima doloremque quod suscipit ad aut quos minus
              dicta commodi error incidunt, laborum facilis provident non hic!
              Distinctio.
            </p>
            <p className="footer-copyright">
              &copy; 2020 TransAll. All rights reserved | Developed with{" "}
