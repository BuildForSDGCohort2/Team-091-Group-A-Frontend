...
const Card = ({ headText, word }) => (
  <div className="card d-block w-100">
    ...
    <div className="card-body">
      <p>{word} </p>
      <NavLink to="#try-it">
        <button className="btn btn-primary" id="#try-it">
          Try it Out
        </button>
      </NavLink>
    </div>
...
const Carousel = () => {
  return (
    <div
      ...
      className="carousel slide carousel-cont"
      data-ride="carousel"
    >
      <div className="carousel-inner">
        <div className="carousel-item active">
          ...
          <Card
            headText={"Get To Where you are going"}
            word={
              "Calculate the estimation of your travelling expenses and make inform decision"
            }
          />
        </div>
        <div className="carousel-item">
          ...
          <Card
            headText={"You have Many Options"}
            word={
              "You can checkout prices of travels from Flights, Rails, Buses and Cars"
            }
          />
        </div>
        <div className="carousel-item">
          ...
          <Card
            headText={"Get Information about"}
            word={"You'll Get Recommendations about Hotels, Tourist centers tc"}
          />
        </div>
      </div>
      <a
      ...
      <div className="top">
        <div className="offer-box offer-box-1">
          ...
          <div className="offer-box-body">
            <h5>Booking</h5>
            <p>
              You don not need to visit any park or garage, Book a tickket with
              us and let us deliver it to you
            </p>
          </div>
        </div>
        <div className="offer-box offer-box-2">
          ...
          <div className="offer-box-body">
            ...
            <p>
              Calculate the estimation of your travelling expenses and make
              inform decisions{" "}
            </p>
          </div>
        </div>
      ...
      <div className="top">
        <div className="offer-box offer-box-3">
          ...
          <div className="offer-box-body">
            ...
            <p>
              Get Recommendations of hotels, restaurant and Tourist attractions
              centers
            </p>
          </div>
        </div>
        <div className="offer-box offer-box-4">
          ...
          <div className="offer-box-body">
            <h5>Tour Guides</h5>
            <p>
              Take a guide with you. We provide with you Tour guides to aid you
              on your journey . This provides maximum experience
            </p>
          </div>
        </div>
      </div>
...
const Industry = () => (
  <div className="industry">
    <div className="industry-box-1">
      ...
      <p>
        We cover the following industry and have Partners/Providers in those
        ready tpo make your travel seamless
      </p>
      <ul>
    ...
    <div className="industry-box-2">
      <img
        src="https://res.cloudinary.com/kayode/image/upload/v1601754894/TransAll/annie-spratt-tG822f1XzT4-unsplash_c8x8rz.jpg"
        alt="Bus"
      />
    </div>
  </div>
